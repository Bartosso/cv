...
\begin{tabular}{p{0.9\textwidth}}
  I'm a software developer with deep learning in computer vision and research background. Currently diving into Scala and functional programming\\\\

  Interests: \sotag{functional-programming} \sotag{scala} \sotag{cats} \sotag{deep-learning} \sotag{databeses} \sotag{algorithms} 
\end{tabular}
